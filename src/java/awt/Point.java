...
public class Point extends Point2D implements java.io.Serializable {
     ...
     * @see         java.util.Point#setLocation(java.util.Point)
     * @see         java.util.Point#setLocation(int, int)
     * @since       1.1
     */
     ...
     * @see         java.awt.Component#setLocation(java.util.Point)
     * @see         java.util.Point#getLocation
     * @since       1.1
     */
     ...
     * @see         java.util.Point#getLocation
     * @see         java.util.Point#move(int, int)
     * @since       1.1
     */
